...
require(["../require-config"], function () {
    require(["zepto"], function ($) {
        $(function () {
            ...
            function getTable() {
                var new_list = '<ul class="tableTr" data-id="111"><li class="twoLine">张三丰<br/>12587433333</li><li class="blue">￥12000</li><li class="green">￥6000</li><li onclick="goCrash(this)">提现</li></ul><ul class="tableTr" data-id="222"><li class="twoLine">张三丰<br/>12587435678</li><li class="blue">￥12000</li><li class="green">￥6000</li><li onclick="goCrash(this)">提现</li></ul>';
